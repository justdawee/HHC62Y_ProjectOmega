...
module Validation =
    ...
    let reasonText (lang: Lang) (r: Reason) : string =
        ...
        | Hu, OnlyDigits    -> "A név nem állhat csupa számból."
        | Hu, RepeatedChars -> "Ez nem tűnik valódi hozzávalónak."
        | Hu, Profanity     -> "Maradjunk a kulturált szavaknál!"
        | Hu, NotFood       -> "Hmm, ez nem hiszem, hogy étel."
